...
LABEL maintainer="oc@co.ru" \
	...
	org.label-schema.vcs-url="https://github.com/vladfilimon/docker-electrum-daemon" \
	org.label-schema.version=$VERSION \
	org.label-schema.docker.cmd='docker run -d --name electrum-daemon --publish 127.0.0.1:7000:7000 --volume /srv/electrum:/data vladfilimon/electrum-daemon' \
